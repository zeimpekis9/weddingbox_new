...
interface EditEventModalProps {
  ...
  onClose: () => void
  event: Event | null
  onUpdateEvent: (eventData: any, coverPhoto: File | null) => void
}
...
export default function EditEventModal({ isOpen, onClose, event, onUpdateEvent }: EditEventModalProps) {
  ...
  const handleSubmit = () => {
    ...
    onUpdateEvent(eventData, coverPhotoFile)
  }
      ...
      <div className="modal-content">
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Update Cover Photo (Optional)</label>
              <input
                type="file"
                accept="image/*"
